...
export default defineConfig({
	// Tailwind v4 has no postcss config: `@import 'tailwindcss'` in
	// $gc/theme.css is resolved by this plugin and by nothing else, so a tier
	// without it fails the BUILD on a bare specifier it cannot open.
