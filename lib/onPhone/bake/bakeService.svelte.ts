...
// A pass that fails this many areas IN A ROW stops and backs off like a timeout
// would. Without it a Worker returning 500s was asked for all 436 areas every
// 20 s — thousands of identical failures per hour (5 Sep 2026).
